...
geomlabel_roland_flickr_20192020_average_colour_plot_colors_plot <- roland_flickr_20192020_average_colour_plot_colors_factor +
  geom_label(aes(label = synth_plotrixcolour, colour = I(synth_plotrixcolour)),
             fontface = "bold") +
