...
gray_only_roland_f_2019_2020_narrow_dataset <- roland_f_2019_2020_narrow_dataset %>% 
  filter(grepl('gray', synth_plotrixcolour))
gray_only_second_of_day_roland_f_2019_2020_narrow_dataset <- 
  gray_only_roland_f_2019_2020_narrow_dataset %>% 
  rowwise() %>% 
...
gray_only_second_of_day_roland_flickr_20192020_average_colour_plot_colours_factor <- ggplot(gray_only_second_of_day_roland_f_2019_2020_narrow_dataset,  aes(second_of_day,synth_plotrixcolour))
gray_geomencircle_roland_flickr_20192020_average_colour_plot_colours_plot <- 
  gray_only_second_of_day_roland_flickr_20192020_average_colour_plot_colours_factor +
