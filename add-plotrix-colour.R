...
# Note, "' gets converted to "NA" by write_csv()
write_csv(df_with_plotrix_colour, "/Users/roland/Documents/GIT/files_too_big_for_github_rt-flickr-sqlite-csv/2020-and-2019-roland-flickr-filename-imagemagick-imavgcolour-plotrixavgcolour-metadata.csv")