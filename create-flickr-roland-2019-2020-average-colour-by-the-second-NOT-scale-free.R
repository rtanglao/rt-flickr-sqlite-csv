# generates
# flickr-roland-2019-2020-average-colour-by-the-second-NOT-scale-free.pdf
# flickr-roland-2019-2020-average-colour-by-the-second-NOT-scale-free.png
...
p4 <- p4_colors_factor + geom_encircle(aes(group=synth_plotrixcolour,
  ...
  geom_point(aes(colour=I(synth_plotrixcolour)))  + facet_wrap(~ pacific_ymd)